...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-blue">Farmacias Aranda <small class="text-muted">POS XS<?php echo settings('POS XS');?></small></h4>
    <br>
    ...
    <div class="text-center">
      <a href="index.php" style="font-size:1.8rem;color:blue;text-decoration:underline;"><small>or</small> Iniciar sesión como un usuario diferente</a>
    </div>
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">© <?php echo date('Y'); ?> <a href="http://grupoxscorpions.com">Powered by Grupo XScorpions</a></div>
    </div>
  </div>
