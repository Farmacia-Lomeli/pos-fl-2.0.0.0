...
<div class="hidden"><?php include('assets/itsolution24/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" value="example@farmacia-lomeli.com" placeholder="Email / Phone No." name="username">
          </div>
        </div>
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@farmacias-aranda.com', 'cashier@farmacias-aranda.com', 'salesman@farmacias-aranda.com'))) : ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://grupoxscorpions.com/">Powered by Grupo XScorpions</a></p>
    </div>
  </section>
